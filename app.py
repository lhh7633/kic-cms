...
# --- 1. 환경 설정 ---
SPREADSHEET_ID = '1q1GuRNow4naFj87WmznVTT00SSH4yhyuiLQykVEjKww' # 사용자님의 시트 ID
FOLDER_ID = '1xk5ERGG6qEHqoVcCv0tJbbiAq3SITVFc'               # 사용자님의 드라이브 폴더 ID
...
with st.sidebar:
    st.header("관리 메뉴")
    if sheet_service:
        st.success("현재 구글 시트 및 드라이브와 연결됨")
    else:
        st.error("연결 안 됨 (인증 필요)")
